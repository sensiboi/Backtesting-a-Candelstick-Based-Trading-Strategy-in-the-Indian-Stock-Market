This project focuses on designing and backtesting a rule-based trading strategy using candlestick patterns in the Indian equity market. The strategy uses Bullish and Bearish Engulfing patterns to generate buy and sell signals and evaluates performance using historical price data sourced from Yahoo Finance.
